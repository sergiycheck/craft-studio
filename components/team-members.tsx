...
export default function TeamMembers() {
  return (
    <section>
      <div className="max-screen-2xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          {/* Section header */}
          <div className="pb-12 md:pb-20">
            <h2 className="h2 mb-4">Meet out team members</h2>
...
function TeamMember({ image, name, title }: TeamMemberProps) {
  return (
    <div className="flex flex-col h-full  border border-gray-700" data-aos="fade-up">
      ...
      <div className="flex flex-col items-center p-6 mt-6 border-t border-gray-700 font-medium">
        <Link
          className="w-fit text-white border border-gray-700 hover:scale-150 transition duration-150 ease-in-out  "
          href="#"
          aria-label="LinkedIn"
        >
          <LinkedInSvg />
